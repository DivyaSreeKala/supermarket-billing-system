...
if($result = $conn->query($sql)){
   ...
   echo '<div class="box2">';
    ...
    echo '<table id="tbl" border=1 width=50% >';
            echo '<tr>';
                echo '<th>pid</th>';
                echo '<th>pname</th>';
...
<input type="submit" name="submit" id="submit" value="calculate total">
...
function ajaxpost(){
  ...
  data.append("product_id", document.getElementById("id").value);
