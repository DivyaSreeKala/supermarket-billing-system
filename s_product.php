...
<html>
<head>
	<title>Sales as per product</title>
...
<ul class="topnav">
  ...
  <li><a class="active" href="s_product.php">Sales per Product</a></li>
...
<div class="box">
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
		Product ID:<input type="text" name="pid" value="">
...
$sql = "SELECT * FROM bill WHERE product_id='$pid'";
